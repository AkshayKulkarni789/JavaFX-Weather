package com.akshay.weathermapFX.app.controller;


import com.akshay.openweathermap.classes.Unit;
import com.akshay.openweathermap.entities.CurrentWeather;
import com.akshay.openweathermap.entities.WeatherForecastDaily;
import com.akshay.openweathermap.exceptions.WeatherDataServiceException;
import com.akshay.openweathermap.interfaces.IWeatherDataService;
import com.akshay.openweathermap.services.DataServiceFactory;
import java.net.URL;
       ...
       public void run() {
        ...
        try {
           ...
           CurrentWeather data = dataService.GET_CURRENT_WEATHER_DATA_BY_CITY_NAME("Constantine");
            ...
            URL iconUrl = getClass().getResource("/com/akshay/weathermapFX/app/resources/images/"+data.getWeather()[0].getIcon()+".png");
